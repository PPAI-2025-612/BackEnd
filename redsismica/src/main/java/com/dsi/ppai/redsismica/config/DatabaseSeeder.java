...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    // NUEVO: Repositorio para los motivos
    ...
    public void run(String... args) throws Exception {
        ...
        if (usuarioRepository.count() == 0) {
            ...
            empleadoRepository.save(carlos);
            ...
            sismo1.setCambioEstado(ce1);
            sismografoRepository.save(sismo1);
            ...
            sismografoRepository.save(sismo2);
            ...
            sismografoRepository.save(sismo3);
            ...
            // Orden 1: Juan (Hace 5 horas) - CERRADA CON MOTIVO
            ...
            // Orden 2: María (Hace 2 días) - Pendiente de cierre
            ...
            // Orden 3: Carlos (Hace 30 minutos) - Pendiente de cierre
            ...
            // Orden 4: Juan (Hace 1 semana) - Pendiente de cierre
